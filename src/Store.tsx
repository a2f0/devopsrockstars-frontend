      ...
      {storeProducts.map(function (product, i) {
        return (
          <>
            {product.storeProductPictures.map(function (picture, i) {
              return (
                <div
                  ...
                  className={classes.flexContainerColumn}
                >
                  <div
                    key={'picture-' + picture.id}
                    className={classes.storePicture}
                  >
                    <ReactSVG
                      src={picture.fullUrl}
                      beforeInjection={(svg) => {
            ...
            <FlexContainerRow>
              <div>centered description</div>
            </FlexContainerRow>
            <FlexContainerRow>
              <div>centered description</div>
            </FlexContainerRow>
            <FlexContainerRow>
              <div className={classes.flex1}>test</div>
              <div className={classes.flex2}>test</div>
            </FlexContainerRow>
          </>
        );
      })}
